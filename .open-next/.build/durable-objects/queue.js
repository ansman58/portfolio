...
// node_modules/.pnpm/@opennextjs+cloudflare@1.14.8_next@16.0.7_@babel+core@7.28.5_react-dom@19.2.0_react@19._b802d99c6c47a47bb52b655d1fe5bd9d/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "6e380b15bde19dd6c3a7c6c27d5bb157",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "E9GHYyeRRuX-7ulOzUQnU");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "E9GHYyeRRuX-7ulOzUQnU");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "E9GHYyeRRuX-7ulOzUQnU");
